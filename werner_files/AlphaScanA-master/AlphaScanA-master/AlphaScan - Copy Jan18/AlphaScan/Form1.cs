...
namespace AlphaScan
{
    public partial class Form1 : Form
    {
        ...
        static Dictionary<string, Reader> _ReaderList = new Dictionary<string, Reader>();
        static RecordTagsFunction RT = new RecordTagsFunction();
        static List<CamControl> _Cams = new List<CamControl>();
        static TagCommFunction TCF = new TagCommFunction();
        bool IsScanning = false;
        private static List<CamConfigSettings> clist;
        public Form1()
        {
            InitializeComponent();
       ...
       public void AddAlertTag (RFIDTag tag)
        ...
        public Dictionary<string, Reader>  ReaderList { get=>_ReaderList; set { _ReaderList = value; } }

        public static List<CamControl> Cams { get => _Cams; set => _Cams = value; }
        public List<CamConfigSettings> Clist { get => clist; set => clist = value; }
